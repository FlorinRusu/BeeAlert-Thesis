...
function showRegisterForm(){
    ...
    $('.loginBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Crează un cont!');
        $('.modal-subtitle').html('Sistem de avertizare socială');
    });
...
function showLoginForm(){
    ...
    $('#loginModal .registerBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Autentifică-te<span> BeeAlert</span>');
        $('.modal-subtitle').html('Introduceți adresă email și parolă');
    });
    $('.error').removeClass('alert alert-danger').html('');
}
